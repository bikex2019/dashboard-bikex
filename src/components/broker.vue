        ...
        <div class="modals-content">
            ...
            <div>
                <form class="col-md-12 row">
                    ...
                    <div class="form-group text-left col-md-3">
                        <label for="answer">DRC</label>
                        <input type="boolean" v-model="does_drc" class="form-control" id="">
                    </div>
                    <div class="form-group text-left col-md-3">
                        <label for="answer">Transfer Of Ownership</label>
                        <input type="boolean" v-model="does_to" class="form-control" id="">
                    </div>
                    <div class="form-group text-left col-md-3">
                        <label for="answer">Hypothecation Cancelltaion</label>
                        <input type="boolean" v-model="does_hc" class="form-control" id="">
                    </div>
                    <div class="form-group text-left col-md-3">
