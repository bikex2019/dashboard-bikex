...
<div class="centres">
    ...
    <table class="table table-striped table-bordered col-md-11 ml-4">
        ...
        <tbody>
            <tr v-for="(faq, index) in paginatedData" :key="index">
                ...
                <td class="py-1">{{faq.refurbishment_received | moment("MMMM Do YYYY")}}</td>
                <td class="py-1">{{faq.modal}}</td>
      ...
      <div class="loader mt-5" style="min-height:200px;" v-if="loading">
            <h5 class="pt-4">Fetching all Under-Refurbish Vehicles's.....</h5>
    ...
    <div class="container" style="margin-top:80px" v-if="loading == false && filteredList.length == 0">
      <p>Sorry :(</p>
      <p>None of our vehicle are Under-Refurbishment</p>
    </div>
     <div class="col-md-12">
                <div class="row">
...
export default {
    ...
    created(){
      this.loading = true
          this.$http.get('https://backend-bikex.herokuapp.com/api/fetch/under-refurbish')
          .then(response=>{
