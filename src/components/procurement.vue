...
<div class="centres">
    ...
    <table class="table table-striped table-bordered col-md-11 ml-4">
        ...
        <tbody>
            <tr v-for="(faq, index) in paginatedData" :key="index" v-on:click="see_vehicle(faq.vehicle_number)">
                ...
                <td>{{faq.status}}</td>
                <td class="py-1"><button class="button btn btn-primary m-0 py-1 custom-button" v-on:click="editModals(faq)"><i class="fa fa-pencil" aria-hidden="true"></i></button>
    ...
    <!-- modals content -->
        <div class="modals-content" style="top:0">
            ...
            <button type="button bt" class="btn btn-danger px-5" v-on:click="procureVehicle">Procure</button>               
            </form>
            </div>
        </div>
