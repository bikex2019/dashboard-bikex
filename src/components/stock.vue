    ...
    <div class="col-md-12 p-4 mb-2 mt-4 col-12 mobile top-content">
            <div class="row">
                <div class="col-md-6 p-0 m-0 pl-4 text-left d-flex justify-content-between">
                  <h5 class="header"><strong>IN STOCK VEHICLES</strong></h5>
                  <vue-json-to-csv
                    :json-data="procured_vehicels"
                    :labels="label"
                    :csv-title="'bikex_live_vehicles_report'"
                    >
    ...
    <table class="table col-md-11" style="margin:0 auto">
        ...
        <tbody>
            <tr v-for="(data, index) in paginatedData" :key="index" class="hand p-3">
                ...
                <td v-on:click="see_vehicle(data.vehicle_id)" class="py-1">{{data.instock_date | moment("MMMM Do YYYY")}}</td>
...
export default {
    ...
    computed:{
      ...
      procured_vehicels(){
         return this.$store.getters.vehicle_status(2);
      },
      modals(){
