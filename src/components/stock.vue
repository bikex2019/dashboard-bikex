...
<div class="centres">
    ...
    <table class="table table-striped table-bordered col-md-11 ml-4">
        ...
        <tbody>
            <tr v-for="(faq, index) in paginatedData" :key="index">
                ...
                <td class="py-1">{{faq.instock_date | moment("MMMM Do YYYY")}}</td>
    ...
    <div class="loader mt-5" style="min-height:200px;" v-if="loading">
            <h5 class="pt-4">Fetching all In Stock Vehicles's.....</h5>
...
export default {
    ...
    created(){
      ...
      this.loading = true
          this.$http.get('https://backend-bikex.herokuapp.com/api/fetch/instock-vehicle')
          .then(response=>{
